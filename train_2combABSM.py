...
Note: 
    2combABSM: train with mixture and ABSM selected drum stems (without using nondrum)
"""
...
def main():
    ...
    exp_name = 'RNNBeat_2combABSM_V'+str(exp_num) + '_'+date
    ...
    model_simpname = '2combABSM_v'+str(exp_num)
    model_dir = exp_dir
    ...
    ssaug_trainset = utils.getExMixset(exMix_dataset_dirs, folderName = 'features', 
                                       ...
                                       drum_abname = "absm_qualified.ab",
                                        main_dir = exMix_main_dir, 
                                        NoDrum= False, OnlyDrum = True)
    ### getting mix dataset
